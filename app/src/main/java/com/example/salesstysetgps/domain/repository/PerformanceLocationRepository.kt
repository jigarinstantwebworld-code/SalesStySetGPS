...
class PerformanceLocationRepository(
        ...
        val callback = object : LocationCallback() {
            ...
            override fun onLocationAvailability(availability: LocationAvailability) {
                if (!availability.isLocationAvailable) {
                    android.util.Log.w("PerformanceRepo", "Location temporarily unavailable")
                }
            }
        }
    ...
    private fun getCurrentCpuUsage(): Float {
        try {
            ...
            val processStatFile = java.io.File("/proc/$pid/stat")
            ...
            val totalStatFile = java.io.File("/proc/stat")
            ...
            android.util.Log.e("PerformanceRepo", "Error reading CPU stats", e)
            return 5f
        }
    }
